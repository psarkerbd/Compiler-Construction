...
static yyconst short int yy_base[16] =
    {   0,
       17,   16,   16,   19,   13,    0,   12,   11,    3,   10,
        0,   19,    7,    9,    8
    } ;

static yyconst short int yy_def[16] =
    {   0,
       13,   13,   12,   12,   14,   12,   14,   15,   12,   15,
       10,    0,   12,   12,   12
    } ;

static yyconst short int yy_nxt[24] =
    {   0,
       12,    6,    8,    7,    9,   11,   10,    5,    5,   10,
        7,    9,    9,    6,    6,   12,    4,    4,    3,   12,
       12,   12,   12
    } ;

static yyconst short int yy_chk[24] =
    {   0,
        0,    6,    6,    6,    9,    9,    9,   13,   13,   15,
       14,   10,    8,    7,    5,    3,    2,    1,   12,   12,
       12,   12,   12
    } ;
